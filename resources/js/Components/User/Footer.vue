    ...
    <footer aria-label="Site Footer" class="bg-white dark:bg-gray-900">
        <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <p
                    class="mt-4 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:text-left lg:mt-0"
                >
            ...
            <div
                class="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 dark:border-gray-800 md:grid-cols-4 lg:grid-cols-6"
            >
                ...
                <div class="text-center sm:text-left md:col-span-4 lg:col-span-2">
                    ...
                    <div class="mx-auto mt-8 max-w-md sm:ml-0">
                        <p
                            class="text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:text-left"
                        >
