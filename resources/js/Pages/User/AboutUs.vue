    ...
    <section class="flex items-center bg-stone-100 xl:h-screen font-poppins dark:bg-white ">
        <div class="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            <div class="flex flex-wrap ">
                ...
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                    <h2 class="mb-4 text-4xl font-semibold text-blue-500 dark:text-black">
                        About Us
                    </h2>
                    <p class="mb-10 text-base leading-7 text-gray-500 dark:text-gray-700">
                    ...
                    <a href="#"
                       class="px-4 py-3 text-blue-700 transition-all transform border border-blue-500 rounded-3xl hover:bg-blue-600 dark:border-amber-400 dark:hover:bg-amber-500 dark:hover:text-gray-100 dark:hover:border-amber-500 dark:text-amber-600 hover:text-gray-100">
                        Discover more
                    </a>
                </div>
            </div>
