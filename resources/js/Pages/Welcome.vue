...
import {get, Inertia, replace} from '@inertiajs/inertia';
import CityCards from "@/Components/User/WelcomePage/CityCards.vue";
import Halls from "@/Pages/User/Halls.vue";
import Cities from "@/Pages/User/Cities.vue";
import CityDropdownList from "@/Components/User/WelcomePage/CityDropdownList.vue";
...
<!--    Why us section -->
        ...
        <div class="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            >
                ...
                >
                    ...
                    <a
                        href="#"
                        class="mt-8 inline-block rounded bg-amber-600 px-12 py-3 text-sm font-medium text-white focus:outline-none focus:ring focus:ring-yellow-400"
                    >
                        See More About Us
                    </a>
                </div>
 ...
 <!--    end Why us section -->
    ...
    <section class="mb-32 mt-16 text-gray-800 text-center">
        ...
        <div id="carouselExampleCaptions" class="carousel slide relative carousel-dark" data-bs-ride="carousel">
            ...
            <button
                class="carousel-control-prev absolute top-0 bottom-0 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline left-20"
                type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
                <span class="carousel-control-prev-icon inline-block bg-no-repeat" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button
                class="carousel-control-next absolute top-0 bottom-0 flex items-center justify-center p-0 text-center border-0 hover:outline-none hover:no-underline focus:outline-none focus:no-underline right-20"
    ...
    <!--  end  customers say ? section  -->



    <!--      footer section -->
    <section class="bg-yellow-100">
        <div class="mx-auto w-full px-4 py-16 sm:px-6 lg:px-1">
            <div
                class="flex flex-col items-center gap-4 rounded-lg bg-yellow-100 p-6  sm:flex-row sm:justify-between"
            >
